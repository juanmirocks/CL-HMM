...
\section{Parameter Estimation for PHMMs}
...
algorithm is defined by induction on the beta probabilities. Note that in HMMs
the alpha and beta variables are categorized by a two-dimensional matrix,
whereas in PHMMs they are three-dimensional matrices.
...
Furthermore, we define the variable:
